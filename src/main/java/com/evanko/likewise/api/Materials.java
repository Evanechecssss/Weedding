...
public class Materials {
    ...
    public static class ArmorMaterials {
        ...
        public static final ItemArmor.ArmorMaterial HOOKAH_SUIT_DISTRICT = EnumHelper.addArmorMaterial("hookah_suit_district", "likewise:hookah_suit_district", 20, new int[]{2, 4, 6, 2}, 5, SoundEvents.BLOCK_NOTE_HAT, 0.5F);
    }
