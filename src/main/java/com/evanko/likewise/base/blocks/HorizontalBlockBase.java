package com.evanko.likewise.base.blocks;
...
public class HorizontalBlockBase extends Block {
    ...
    public HorizontalBlockBase(String name, Material material, CreativeTabs tabs, SoundType soundType, int hardness, int resistance, int lightOpacity, int lightLevel, String toolClass, int toolLevel) {
        super(material);
