package top.evanechecssss.weedding.entities.models;// Made with Blockbench 3.8.4
...
public class ExoskeletonModel extends ModelBiped {
    ...
    public ExoskeletonModel(int type) {
        ...
        Head.cubeList.add(new ModelBox(Head, 32, 32, -4.0F, -8.0F, -4.0F, 8, 8, 8, 1F, false));
        Head.cubeList.add(new ModelBox(Head, 64, 30, -4.0F, -8.0F, -4.0F, 8, 8, 8, 1F, false));

        Body = new ModelRenderer(this);
        Body.setRotationPoint(0.0F, 0.0F, 0.0F);
        Body.cubeList.add(new ModelBox(Body, 48, 48, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, false));
        Body.cubeList.add(new ModelBox(Body, 48, 64, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.25F, false));

        RightArm = new ModelRenderer(this);
        RightArm.cubeList.add(new ModelBox(RightArm, 72, 48, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
        RightArm.cubeList.add(new ModelBox(RightArm, 72, 64, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.25F, false));

        LeftArm = new ModelRenderer(this);
        LeftArm.cubeList.add(new ModelBox(LeftArm, 64, 80, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
        LeftArm.cubeList.add(new ModelBox(LeftArm, 80, 80, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.25F, false));

        RightLeg = new ModelRenderer(this);
        RightLeg.cubeList.add(new ModelBox(RightLeg, 32, 48, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
        RightLeg.cubeList.add(new ModelBox(RightLeg, 32, 64, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.25F, false));

        LeftLeg = new ModelRenderer(this);
        LeftLeg.cubeList.add(new ModelBox(LeftLeg, 48, 80, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
        LeftLeg.cubeList.add(new ModelBox(LeftLeg, 32, 80, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.25F, false));
