...
public class WeeddingBlocks {
    ...
    public static Block GRAMOPHONE_IRON = new GramophoneBlock("gramophone_iron", Material.IRON, 20, 20, "pickaxe", 2, WeeddingCreativeTabs.WEEDDING_CT, SoundType.METAL, 0, 0);
