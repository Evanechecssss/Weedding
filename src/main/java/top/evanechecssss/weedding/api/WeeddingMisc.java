...
public class WeeddingMisc {
    ...
    public static class ArmorMaterials {
        ...
        public static final ItemArmor.ArmorMaterial EXOSKELETON = EnumHelper.addArmorMaterial("exoskeleton", "weedding:exoskeleton", 80, new int[]{25, 25, 25, 25}, 20, SoundEvents.BLOCK_ANVIL_USE, 20F);
    }
    ...
    public static class Rarity {
        ...
        public static final EnumRarity ANTIQUES = EnumHelper.addRarity("antiques",TextFormatting.GOLD,"Antiques");
